    ...
    html: `
        ...
        <div class="mail_template"
            ...
            <div style="margin-top: 30px;">
                ...
                <p style="font-size: 18px; color: #555;"> your withdrawal of $${userInfo.amount} from your Alpha Capital Finance trading account has been submitted, funds would be credited to your account once your withdrawal gets approved.</p>
            </div>
            <div style="margin-top: 30px;">
                <p style="font-size: 18px; color: #555;"> For more detailed informations, please contact our customer support</p>
            </div>
