    ...
    html: `
        ...
        <div class="mail_template"
            ...
            <div style="margin-top: 30px;">
                ...
                <p style="font-size: 18px; color: #555;"> your withdrawal of $${userInfo.amount} from your momentumgloballtd trading account was successful and funds has been credited to the wallet specified during withdrawal</p>
            </div>
            <div style="margin-top: 30px;">
